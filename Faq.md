...
Turvalisuse kaalutlustel, samamoodi nagu TARA-s. redirect_uri tuleb registreerida liitumistaotluses ja seda saab hiljem muuta kirjutades [klient@ria.ee](mailto:klient@ria.ee).
...
Uue saladuse (client_secret) väljastamiseks kontakteeru [klient@ria.ee](mailto:klient@ria.ee). Kindlasti lisa vastava teenuse client_id millele saladust soovitakse.
...
Ei leidnud oma küsimusele vastust? Kontakteeru Riigi Infosüsteemi Ametiga: [klient@ria.ee](mailto:klient@ria.ee). Kui sa oled juba GovSSO teenusega liitunud siis kindlasti lisa ka oma infopäringusse client_id väärtus.
{: .adv}
